    ...
    return (
        <div className="relative">
            ...
            <div className="absolute inset-0">
                <div className="flex justify-center items-center text-center flex-col relative z-30 mx-auto mt-4 sm:mt-6 xl:mt-12 w-[90%] sm:w-max bg-custom-gradient-3 rounded-xl text-white py-8 sm:py-10 xl:py-16 px-0 sm:px-7 md:px-10 gap-4 xl:gap-6">
