        ...
        <div className="">
            <div className="relative w-full z-0 h-lvh">
                ...
                <img
                    ...
                    className="absolute top-[25px] left-[205px] sm:left-[245px] lg:left-[290px] max-w-[175px] sm:max-w-[245px] lg:max-w-[275px]"
                />
                <img
                ...
                <img
                    ...
                    className="absolute bottom-[55px] sm:bottom-[40px] left-[-100px] sm:left-[-45px] lg:left-[10px] max-w-[265px] sm:max-w-[335px] lg:max-w-[365px]"
                />
                <img
                    src="./blue-spongebob-flower.png"
                    alt="blue spongebob flower"
                    className="absolute bottom-[95px] sm:bottom-[110px] right-[35px] md:right-[90px] max-w-[135px] sm:max-w-[205px] lg:max-w-[265px]"
                />
            </div>
        </div>
    );
